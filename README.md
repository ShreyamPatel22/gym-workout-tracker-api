...
**Setup:** Login as `john@example.com`, get workout ID from GET /api/workouts
...
**Setup:** Login as `admin@example.com` / `admin123`
...
**Setup:** Login as `john@example.com`, get a workout ID from GET /api/workouts and an exercise ID from GET /api/exercises
...
**Setup:** Login as `john@example.com`, get a log ID from GET /api/workoutlogs
